...
void loop()
{
  ...
  while(Serial.available()){
    ...
    if (SerialData == "1"){
      ...
      turn_right(1);
    else if (SerialData == "sit")
      sit();
    else if (SerialData == "stand")
      stand();
    else if (SerialData == "dance")
      body_dance(1);
    else if (SerialData == "shake")
      hand_shake(1);
    else if(SerialData == "wave")
      hand_wave(1);
...
void polar_to_servo(int leg, float alpha, float beta, float gamma)
{
  ...
  if (leg == 1 || leg == 2){
    servo[leg][2].write(abs(180-gamma));
  }
  else
